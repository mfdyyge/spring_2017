...
public class BuildCodeService {
    public BuildCodeService() {
        dbTools = DbTools.getInstance();
    }
    public BuildCodeService(String ProperName) {
...
//        createByTemplate(mapParam);
    ...
    public void createConfig(String fileName) {
        ...
        mapParam.put("FTL_NAME", "spring-dubbo-conf-new.ftl");
    ...
    public static void main(String args[]) {
        BuildCodeService buildCode = new BuildCodeService();
